...
class ReorderableListView extends StatefulWidget {
  ...
  ReorderableListView({
    ...
    this.padding,
    this.reverse = false,
    this.dragItemBackground = const Color(0x00000000),
    this.dragItemElevation = 6.0,
  })  : assert(scrollDirection != null),
        assert(onReorder != null),
        assert(dragItemBackground != null),
        assert(dragItemElevation != null),
  ...
  final Color dragItemBackground;

  /// The elevation of the current item being dragged.
  /// Default elevation value is 6.0
  final double dragItemElevation;
    ...
    _listOverlayEntry = OverlayEntry(
      ...
      builder: (BuildContext context) {
        return _ReorderableListContent(
          ...
          dragItemBackground: widget.dragItemBackground,
          dragItemElevation: widget.dragItemElevation,
        );
      },
    );
  }
...
class _ReorderableListContent extends StatefulWidget {
  const _ReorderableListContent({
    ...
    @required this.dragItemElevation,
    @required this.dragItemBackground,
  });
    ...
    Widget buildDragTarget(BuildContext context, List<Key> acceptedCandidates,
      ...
      Widget child = LongPressDraggable<Key>(
        ...
        feedback: Container(
          ...
          child: Material(
            elevation: widget.dragItemElevation,
            child: toWrapWithSemantics,
            color: widget.dragItemBackground,
          ),
        ),
